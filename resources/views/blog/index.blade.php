    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-16 w-full">
        ...
        <nav class="flex justify-end mb-8 anim-fade-in-down anim-delay-100">
            <ol class="flex items-center gap-2 text-sm bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full">
                ...
                <li>
                    <span class="text-brand-yellow font-medium">Blog</span>
                </li>
            </ol>
        </nav>
...
<section class="py-16 bg-white" x-data="{ shown: false }" x-intersect:enter.once="shown = true">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-16">
            ...
            <a href="{{ route('blog.show', 'how-to-maximize-your-rice-yield-this-planting-season') }}" class="group block transition-all duration-700 delay-100"
               :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center bg-gray-50 rounded-3xl overflow-hidden">
                    <div class="blog-image aspect-[4/3] lg:aspect-auto lg:h-[400px]">
                        <img src="https://images.unsplash.com/photo-1625246333195-78d9c38ad449?w=800&h=600&fit=crop" alt="Featured Post" class="w-full h-full object-cover">
                    </div>
                    <div class="p-8 lg:pr-12">
                        <div class="mb-4">
                            <span class="bg-brand-green/10 text-brand-green px-3 py-1 rounded-full text-sm font-medium">Farming Tips</span>
                        </div>
                        ...
                        <p class="text-gray-600 text-lg leading-relaxed line-clamp-3">
                            Discover the proven techniques and best practices that have helped thousands of Filipino farmers achieve up to 50% increase in their rice yields. Learn about optimal planting schedules, soil preparation, and nutrient management.
                        </p>
                    </div>
                </div>
            </a>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 mb-12">
            ...
            <div class="flex flex-wrap gap-2 transition-all duration-500 delay-100" :class="shown ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-8'">
                <button class="px-4 py-2 bg-brand-green text-white rounded-full text-sm font-medium transition-colors">All</button>
                <button class="px-4 py-2 bg-white text-gray-700 hover:bg-brand-green hover:text-white rounded-full text-sm font-medium transition-colors">Farming Tips</button>
                <button class="px-4 py-2 bg-white text-gray-700 hover:bg-brand-green hover:text-white rounded-full text-sm font-medium transition-colors">Success Stories</button>
                <button class="px-4 py-2 bg-white text-gray-700 hover:bg-brand-green hover:text-white rounded-full text-sm font-medium transition-colors">News</button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <!-- Blog Card 1 -->
            <a href="{{ route('blog.show', 'from-struggling-to-thriving-a-farmers-journey-with-rhizocote') }}"
               class="blog-card bg-white rounded-2xl shadow-sm overflow-hidden transition-all duration-500"
               :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'"
               :style="shown ? 'transition-delay: 150ms' : ''">
                <div class="blog-image aspect-[16/10]">
                    <img src="https://images.unsplash.com/photo-1574943320219-553eb213f72d?w=600&h=400&fit=crop" alt="Blog Post" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <div class="mb-3">
                        <span class="bg-brand-yellow/20 text-brand-dark px-3 py-1 rounded-full text-xs font-medium">Success Stories</span>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 hover:text-brand-green transition-colors">
                        From Struggling to Thriving: A Farmer's Journey with Rhizocote
                    </h3>
                    <p class="text-gray-600 text-sm leading-relaxed line-clamp-3 mb-4">
                        Meet Pedro, a rice farmer from Nueva Ecija who transformed his farm's productivity using AniSenso's innovative farming techniques.
                    </p>
            ...
            <!-- Blog Card 2 -->
            <a href="{{ route('blog.show', '5-essential-soil-preparation-techniques-for-better-harvest') }}"
               class="blog-card bg-white rounded-2xl shadow-sm overflow-hidden transition-all duration-500"
               :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'"
               :style="shown ? 'transition-delay: 250ms' : ''">
                <div class="blog-image aspect-[16/10]">
                    <img src="https://images.unsplash.com/photo-1592982537447-7440770cbfc9?w=600&h=400&fit=crop" alt="Blog Post" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <div class="mb-3">
                        <span class="bg-brand-green/10 text-brand-green px-3 py-1 rounded-full text-xs font-medium">Farming Tips</span>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 hover:text-brand-green transition-colors">
                        5 Essential Soil Preparation Techniques for Better Harvest
                    </h3>
                    <p class="text-gray-600 text-sm leading-relaxed line-clamp-3 mb-4">
                        Proper soil preparation is the foundation of a successful harvest. Learn the five techniques that every farmer should know.
                    </p>
                    <div class="pt-4 border-t border-gray-100">
                        <span class="text-brand-green text-sm font-medium">Read More</span>
                    </div>
            ...
            <!-- Blog Card 3 -->
            <a href="{{ route('blog.show', 'anisenso-partners-with-da-for-nationwide-farmer-training') }}"
               class="blog-card bg-white rounded-2xl shadow-sm overflow-hidden transition-all duration-500"
               :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'"
               :style="shown ? 'transition-delay: 350ms' : ''">
                <div class="blog-image aspect-[16/10]">
                    <img src="https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?w=600&h=400&fit=crop" alt="Blog Post" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <div class="mb-3">
                        <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-medium">News</span>
                    </div>
                    <h3 class="text-xl font-bold text-gray-900 mb-3 line-clamp-2 hover:text-brand-green transition-colors">
                        AniSenso Partners with DA for Nationwide Farmer Training
                    </h3>
                    <p class="text-gray-600 text-sm leading-relaxed line-clamp-3 mb-4">
                        A new partnership aims to bring modern farming techniques to over 100,000 Filipino farmers across all regions.
                    </p>
                    <div class="pt-4 border-t border-gray-100">
                        <span class="text-brand-green text-sm font-medium">Read More</span>
                    </div>
            ...
            <!-- Blog Card 4 -->
            <a href="{{ route('blog.show', 'understanding-micronutrients-what-your-crops-really-need') }}"
               class="blog-card bg-white rounded-2xl shadow-sm overflow-hidden transition-all duration-500"
               :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'"
               :style="shown ? 'transition-delay: 450ms' : ''">
                <div class="blog-image aspect-[16/10]">
                    <img src="https://images.unsplash.com/photo-1464226184884-fa280b87c399?w=600&h=400&fit=crop" alt="Blog Post" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <div class="mb-3">
                        <span class="bg-brand-green/10 text-brand-green px-3 py-1 rounded-full text-xs font-medium">Farming Tips</span>
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed line-clamp-3 mb-4">
                        A comprehensive guide to understanding the role of micronutrients in plant growth and how to identify deficiencies.
                    </p>
                    <div class="pt-4 border-t border-gray-100">
                        <span class="text-brand-green text-sm font-medium">Read More</span>
                    </div>
            ...
            <!-- Blog Card 5 -->
            <a href="{{ route('blog.show', 'community-farming-how-cooperatives-are-changing-lives') }}"
               class="blog-card bg-white rounded-2xl shadow-sm overflow-hidden transition-all duration-500"
               :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'"
               :style="shown ? 'transition-delay: 550ms' : ''">
                <div class="blog-image aspect-[16/10]">
                    <img src="https://images.unsplash.com/photo-1500937386664-56d1dfef3854?w=600&h=400&fit=crop" alt="Blog Post" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <div class="mb-3">
                        <span class="bg-brand-yellow/20 text-brand-dark px-3 py-1 rounded-full text-xs font-medium">Success Stories</span>
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed line-clamp-3 mb-4">
                        Discover how farming cooperatives supported by AniSenso are creating sustainable livelihoods for rural communities.
                    </p>
                    <div class="pt-4 border-t border-gray-100">
                        <span class="text-brand-green text-sm font-medium">Read More</span>
                    </div>
            ...
            <!-- Blog Card 6 -->
            <a href="{{ route('blog.show', '2026-planting-calendar-best-times-for-major-crops') }}"
               class="blog-card bg-white rounded-2xl shadow-sm overflow-hidden transition-all duration-500"
               :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'"
               :style="shown ? 'transition-delay: 650ms' : ''">
                <div class="blog-image aspect-[16/10]">
                    <img src="https://images.unsplash.com/photo-1605000797499-95a51c5269ae?w=600&h=400&fit=crop" alt="Blog Post" class="w-full h-full object-cover">
                </div>
                <div class="p-6">
                    <div class="mb-3">
                        <span class="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-xs font-medium">News</span>
                    ...
                    <p class="text-gray-600 text-sm leading-relaxed line-clamp-3 mb-4">
                        Plan your year with our comprehensive planting calendar, featuring optimal dates for rice, corn, vegetables, and more.
                    </p>
                    <div class="pt-4 border-t border-gray-100">
                        <span class="text-brand-green text-sm font-medium">Read More</span>
                    </div>
        ...
        <div class="flex justify-center mt-12 transition-all duration-500 delay-700"
            ...
            <nav class="flex items-center gap-2">
                <button class="w-10 h-10 flex items-center justify-center rounded-full bg-white text-gray-400 hover:bg-gray-50 transition-colors" disabled>
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/></svg>
                </button>
                <button class="w-10 h-10 flex items-center justify-center rounded-full bg-brand-green text-white font-medium">1</button>
                <button class="w-10 h-10 flex items-center justify-center rounded-full bg-white text-gray-700 hover:bg-gray-50 font-medium transition-colors">2</button>
                <button class="w-10 h-10 flex items-center justify-center rounded-full bg-white text-gray-700 hover:bg-gray-50 font-medium transition-colors">3</button>
                <span class="text-gray-400 px-2">...</span>
                <button class="w-10 h-10 flex items-center justify-center rounded-full bg-white text-gray-700 hover:bg-gray-50 font-medium transition-colors">8</button>
                <button class="w-10 h-10 flex items-center justify-center rounded-full bg-white text-gray-700 hover:bg-brand-green hover:text-white transition-colors">
...
<section class="py-20 bg-brand-dark relative overflow-hidden" x-data="{ shown: false }" x-intersect:enter.once="shown = true">
    ...
    <div class="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p class="text-xl text-white/70 mb-10 max-w-2xl mx-auto transition-all duration-500 delay-200"
           :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'">
            Join thousands of Filipino farmers who are transforming their farms with modern techniques. Get exclusive access to training, resources, and a supportive community.
        </p>
        ...
        <p class="text-white/50 text-sm mt-8 transition-all duration-500 delay-400"
           :class="shown ? 'opacity-100' : 'opacity-0'">
            Already trusted by 10,000+ farmers across the Philippines
        </p>
    </div>
</section>
@endsection
